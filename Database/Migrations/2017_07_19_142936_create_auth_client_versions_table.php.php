...
class CreateAuthClientVersionsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
{
    Schema::create('auth_client_versions', function (Blueprint $table) {
...
{
    Schema::dropIfExists('auth_client_versions');
}
}
